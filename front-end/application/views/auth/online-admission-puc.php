...
<body style="background: #f7f7f7">
                    ...
                    <div class="online-start">
                        <div class="admission-back">
                            <div class="make-payment">
                                <h5>Online Admission Form for Class 11 or 1st PUC</h5>
                                <p>Richard McClintock, a discovering the source behind the ubiquitous Richard
                                    McClintock, a Latin scholar </P>
                            </div>
                            <div class="admission-form">
                                <form action="<?php echo base_url('authentication/admission_puc');?>"
                                    method="POST" id="admission-form" enctype= multipart/form-data>
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group online-reg">
                                                <textarea class="form-control online-textarea" rows="1"
                                                    ...
                                                    name="adhar"><?php echo set_value('adhar');?></textarea>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group online-reg">
                                                <select class="form-control online-select" id="ad_batch" name="center"  required>
                                                    ...
                                                    <option value="Kengeri (CBSE)" <?php echo set_select('center','Kengeri (CBSE)', ( !empty($list) && $list == "Kengeri (CBSE)" ? TRUE : FALSE )); ?> >Kengeri (CBSE)</option>
                                                    <option value="Uttarahalli Road (PU)" <?php echo set_select('center','Uttarahalli Road (PU)', ( !empty($list) && $list == "Uttarahalli Road (PU)" ? TRUE : FALSE )); ?> >Uttarahalli Road (PU)</option>
                                                    <option value="Kanakpura Road(Residential Campus)" <?php echo set_select('center','Kanakpura Road(Residential Campus)', ( !empty($list) && $list == "Kanakpura Road(Residential Campus)" ? TRUE : FALSE )); ?> >Kanakpura
                                                        Road(Residential Campus)</option>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group online-reg custom-file">
                                                <input type="file" class="form-control custom-file-input online-input "
                                                    placeholder="Class 10 Preparatory Percentage *" accept=" .png,.jpg,jpeg,.pdf" name="marksheet" id="customFile"  value="<?php echo set_value('marksheet');?>"
                                                    accept="image/jpeg,image/gif,image/png, application/pdf"  ><?php echo form_error('marksheet');?>
                                                    <label class="custom-file-label" for="customFile">Class 10 Preparatory </label>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group online-reg">
                                                <select class="form-control online-select" id="ad_batch" name="batch"  required>
                                                    <option selected disabled>Select Your Batch</option>
                                                    <option
                                                        value="2-Years Full-Time Super 30 Classroom Program(Day Scholar)" <?php echo set_select('batch','2-Years Full-Time Super 30 Classroom Program(Day Scholar)', ( !empty($batch_list) && $batch_list == "2-Years Full-Time Super 30 Classroom Program(Day Scholar)" ? TRUE : FALSE )); ?>>
                                                        2-Years Full-Time Super 30 Classroom Program(Day Scholar)
                                                    </option>
                                                    <option
                                                        value="2-Year Full-Time Super 30 Classroom Program (Residential)" <?php echo set_select('batch','2-Year Full-Time Super 30 Classroom Program (Residential)', ( !empty($batch_list) && $batch_list == "2-Year Full-Time Super 30 Classroom Program (Residential)" ? TRUE : FALSE )); ?>>
                                                        2-Year Full-Time Super 30 Classroom Program (Residential)
                                                    </option>
                                                    <option value="JEE Evening Batch" <?php echo set_select('batch','JEE Evening Batch', ( !empty($batch_list) && $batch_list == "JEE Evening Batch" ? TRUE : FALSE )); ?>>JEE Evening Batch</option>
                                                    <option value="NEET Evening Batch" <?php echo set_select('batch','NEET Evening Batch', ( !empty($batch_list) && $batch_list == "NEET Evening Batch" ? TRUE : FALSE )); ?>>NEET Evening Batch</option>
                                                    <option value="KVPY Weekend Batch" <?php echo set_select('batch','KVPY Weekend Batch', ( !empty($batch_list) && $batch_list == "KVPY Weekend Batch" ? TRUE : FALSE )); ?>>KVPY Weekend Batch</option>
                                                    <option value="JEE+NEET+KVPY (7 Days a week)" <?php echo set_select('batch','JEE+NEET+KVPY (7 Days a week)', ( !empty($batch_list) && $batch_list == "JEE+NEET+KVPY (7 Days a week)" ? TRUE : FALSE )); ?>>JEE+NEET+KVPY (7 Days
                                                        a week)</option>
                                                </select>
    ...
    <?php
if(isset($_POST['submit-pay']) && $this->session->userdata('puc')=='puc')
{ 
    $name 		= $_POST['name'];
   ...
   ?>
                        ...
                        <input name="amount" type="hidden" value=" <?php echo  (!empty($amount->puc_amount))?$amount->puc_amount:''; ?>">
                        <input name="id" type="hidden" value=" <?php echo  (!empty($insert_id))?$insert_id:''; ?>">
                            <script src="https://checkout.razorpay.com/v1/checkout.js"
                                ...
                                data-amount="<?php echo  ((int)($amount->puc_amount))*100; ?>"
